    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="max-w-7xl mx-auto p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <Card className="sm:col-span-2 bg-gradient-to-br from-blue-800 to-blue-600 text-white">
            <CardHeader className="p-4 sm:p-6">
                      ...
                      <div className="flex items-start justify-between flex-col sm:flex-row gap-2 sm:gap-4">
                        <CardTitle className="flex items-start gap-2 text-lg sm:text-xl">
                          ...
                          <span className="leading-tight">
                            {toTitleCase(doc.title).split("Nº").join("nº") +
                              " de " +
                              formatarDataPorExtenso(doc.date)}
                          </span>
                        </CardTitle>
                      </div>
